...
async def detection_loop():
    ...
    while state.is_running:
        ...
        if state.fall_probability > state.threshold:
            ...
            # Use float timestamp for comparison instead of parsing string back to datetime
            if current_time_float - state.last_alert_time >= 2.0:
                # ⚡ Bolt: Defer computationally expensive string formatting
                # until *after* conditional check passes
                alert = {
