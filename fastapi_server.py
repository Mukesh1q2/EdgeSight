...
class DetectionState:
    def __init__(self):
        ...
        self.last_alert_time = 0.0  # Float timestamp for fast cooldown checking
...
async def detection_loop():
    ...
    while state.is_running:
        ...
        if state.fall_probability > state.threshold:
            ...
            # Optimization: Use float timestamp for fast checking before allocating string objects
