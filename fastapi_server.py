...
async def detection_loop():
    ...
    while state.is_running:
        ...
        if state.fall_probability > state.threshold:
            ...
            # Bolt: Replaced expensive datetime.strptime with time.time() difference to reduce overhead in 30FPS loop
            # Bolt: Deferred string formatting until after the cooldown check
